...
(function (Libs) {
    ...
    (function (HorizontalTimeline) {
        HorizontalTimeline.eventsMinDistance = 60;
        function initTimeline(timelines) {
            timelines.each(function () {
                ...
                setDatePosition(timelineComponents, HorizontalTimeline.eventsMinDistance);
                //assign a width to the timeline
                var timelineTotWidth = setTimelineWidth(timelineComponents, HorizontalTimeline.eventsMinDistance);
        ...
        HorizontalTimeline.initTimeline = initTimeline;
        function updateSlide(timelineComponents, timelineTotWidth, string) {
            ...
            (string == 'next')
                ? translateTimeline(timelineComponents, translateValue - wrapperWidth + HorizontalTimeline.eventsMinDistance, wrapperWidth - timelineTotWidth)
                : translateTimeline(timelineComponents, translateValue + wrapperWidth - HorizontalTimeline.eventsMinDistance);
        }
        ...
        function updateFilling(selectedEvent, filling, totWidth) {
            ...
            var _eventLeft = eventStyle.getPropertyValue("left");
            var eventWidth = eventStyle.getPropertyValue("width");
            var eventLeft = Number(_eventLeft.replace('px', '')) + Number(eventWidth.replace('px', '')) / 2;
        ...
        function getTranslateValue(timeline) {
            ...
            if (timelineTranslate.indexOf('(') >= 0) {
                ...
                var _timelineTranslate = timelineTranslate.split(',');
                var translateValue = _timelineTranslate[4];
            }
            else {
        ...
        function parseDate(events) {
            ...
            events.each(function () {
                ...
                var newDate = new Date(Number(dayComp[2]), Number(dayComp[1]) - 1, Number(dayComp[0]), Number(timeComp[0]), Number(timeComp[1]));
