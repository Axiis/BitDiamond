...
namespace BitDiamond.Web.Controllers.Api
{
    public class AccountController : ApiController
    {
        ...
        => this.Log(() => Operation.Try(() => _account.GetRoles())
            .OperationResult(Request));

        [HttpGet, Route("api/accounts/users/current")]
        public IHttpActionResult GetSignedInUser()
        => this.Log(() => Operation.Try(() => _account.CurrentUser())
            .OperationResult(Request));
        #endregion
        ...
        => this.Log(() => _account.GetBioData().OperationResult(Request));
        #endregion
        ...
        => this.Log(() => _account.GetContactData().OperationResult(Request));
        #endregion
        ...
        => this.Log(() => _account.GetUserData().OperationResult(Request));
